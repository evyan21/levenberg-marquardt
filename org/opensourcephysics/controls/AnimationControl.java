...
public class AnimationControl extends OSPControl {
  ...
  String MPToolTipText = ControlsRes.ALLOY_TIP;
  String MPText = ControlsRes.ALLOY;
  ...
  JButton MPBtn = new JButton(ControlsRes.ALLOY); // Material Property
  ...
  public AnimationControl(Animation animation) {
    ...
    MPBtn.addActionListener(new MPBtnListener());
    MPBtn.setToolTipText(MPToolTipText);
  ...
  protected void refreshGUI() {
    ...
    MPToolTipText = ControlsRes.ALLOY_TIP;
    ...
    MPBtn.setText(ControlsRes.ALLOY);
    MPBtn.setToolTipText(MPToolTipText);
  ...
  void MPBtnActionPerformed(ActionEvent e) {
    ((Animation) model).showMP();
  }
  ...
  class ResetBtnListener implements ActionListener {
    ...
    class MPBtnListener implements ActionListener {
    /**
     * Method actionPerformed
     *
     * @param e
